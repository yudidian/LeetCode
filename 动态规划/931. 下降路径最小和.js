...
var minFallingPathSum = function (matrix) {
  ...
  */
  ...
  function dp(i, j) {
    ...
    const val = matrix[i][j] + Math.min(dp(i - 1, j), dp(i - 1, j + 1), dp(i - 1, j - 1))
    map.set("" + i + j, val)
    return val
  }
};
